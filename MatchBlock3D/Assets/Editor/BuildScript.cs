...
public static class BuildScript
{
    public static void BuildIos()
    {
        ...
        const string appIconPath = "Assets/Brand/CubicMatchscape-AppIcon.png";
        Directory.CreateDirectory(outputPath);

        PlayerSettings.companyName = "Playable Games";
        PlayerSettings.productName = "Cubic Matchscape";
        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS, "Com.play.matchblock");
